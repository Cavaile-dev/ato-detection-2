...
# Progressive scoring (global -> personal)
ENABLE_PROGRESSIVE_BLEND = True
MIN_PERSONAL_PROFILE_SAMPLES = 3
PERSONAL_BLEND_START_SAMPLES = 3
PERSONAL_BLEND_FULL_SAMPLES = 20
